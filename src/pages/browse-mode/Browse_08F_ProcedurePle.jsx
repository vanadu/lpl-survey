  ...
  return (
    <>
      ...
      <div className="browse-page-nav" aria-label="Browse page navigation">
        <Link className="browse-page-nav__prev" href="/browse-mode/Browse_08E_ProcedureVcc" aria-label="Previous page">
        ...
        <Link className="browse-page-nav__next" href="/browse-mode/Browse_08G_ProcedureTt" aria-label="Next page">
      ...
      <div className="browse-panel-container" id="ProcedurePLEHeadPanel">
      <div className="browse-content-block" id="ProcedurePLEHeading">
        <h2 className="browse-content-heading">Questions About Bella&lsquo;s Partial Laryngectomy Surgery</h2>
      </div>
      ...
      <div className="browse-question-container" id="ProcedurePLEComplications">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePLEComplicationsType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePLEMedicationsType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePLEFollowupCost">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
...
export default Browse_08F_ProcedurePle;
