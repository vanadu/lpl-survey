...
const Browse_10_Breathing = () => {
  ...
  return (
    <>
        ...
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Did Bella ever have a breathing crisis that caused you to fear for her life?
            </span>
          }
          index={1}
      ...
      <div className="browse-question-container" id="BreathingEmergencyDidHave">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Did Bella ever have a breathing emergency that required a visit to a veterinary professional?
            </span>
          }
          index={3}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="BreathingEmergencyCount">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingEmergencyCost">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingCrisisAdviceType">
        ...
        >
          ...
          <ul>
            ...
            <li className="browse-showanswer-checkbox">
              <span className="browse-showanswer-icon browse-showanswer-icon--checkbox" aria-hidden="true"></span>
              <span>Administer supplemental oxygen</span>
            </li>
            <li className="browse-showanswer-checkbox">
              <span className="browse-showanswer-icon browse-showanswer-icon--checkbox" aria-hidden="true"></span>
      ...
      <div className="browse-question-container" id="BreathingCrisisProductRecommended">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingCrisisProductRecommendedType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              What substance or product did they provide or recommend?
            </span>
          }
          index={9}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="BreathingCrisisProductRecommendedForm">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingOxygenDidUse">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingCrisisOxygenPrevent">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingCrisisOxygenRevive">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-panel-container" id="BreathingAspirationPanel">
      <div className="browse-question-container" id="BreathingAspirationDidHave">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingAspirationCount">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingAspirationAfterProcedure">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              How many times did Bella get aspiration pneumonia after the surgery or stent procedure?
            </span>
          }
          index={16}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="BreathingAspirationInpatient">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingAspirationInpatientCount">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="BreathingAspirationCost">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
