  ...
  return (
    <>
      ...
      <div className="browse-page-nav" aria-label="Browse page navigation">
        <Link className="browse-page-nav__prev" href="/browse-mode/Browse_03_Factors" aria-label="Previous page">
        ...
        <div className="browse-page-marker" id="SYMPTOMS-page"></div>
        <Link className="browse-page-nav__next" href="/browse-mode/Browse_05_Primary" aria-label="Next page">
      ...
      <div className="browse-question-container" id="SymptomsAgeMonths">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Months (number 0 - 11)
      ...
      <div className="browse-question-container" id="SymptomsSeverity">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="SymptomsIntubationSymptoms">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-panel-container" id="SymptomsCard2Panel">
      <div className="browse-panel-container" id="SymptomsOtherConditionsPanel">
      <div className="browse-question-container" id="SymptomsOtherConditions">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="SymptomsOtherConditionsType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
...
export default Browse_04_Symptoms;
