  ...
  return (
    <>
      ...
      <div className="browse-panel-container" id="ProcedurePAEAgePanel">
        <h3 className="browse-showanswer-title">About how old was Bella when she had the artytenoidectomy surgery for LP?</h3>
      ...
      <div className="browse-question-container" id="ProcedurePAEDifference">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Did the surgeon explain the difference between the partial arytenoidectomy and other surgery or procedure types?
            </span>
          }
          index={5}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="ProcedurePAELaser">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Was the arytenoidectomy performed with a laser?
            </span>
          }
          index={6}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="ProcedurePAEChoice">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              Did the surgeon offer you a choice between partial arytenoidectomy and any other procedure type?
            </span>
          }
          index={7}
          activeIndex={activeIndex}
      ...
      <div className="browse-content-block" id="ProcedurePAEPostOpHeading">
      ...
      <div className="browse-question-container" id="ProcedurePAEComplications">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEComplicationsType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEMedicationsType">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-panel-container" id="ProcedurePAECostPanel">
      <div className="browse-content-block" id="ProcedurePAECostHeading">
      ...
      <div className="browse-question-container" id="ProcedurePAEFollowupCost">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-panel-container" id="ProcedurePAEConditionPanel">
      <div className="browse-content-block" id="ProcedurePAEConditionHeading">
        <p className="browse-content-text">These questions are about Bella&lsquo;s condition in the weeks after the surgery.</p>
      </div>

      <div className="browse-question-container" id="ProcedurePAEBreathingPostOp">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              How would you rate Bella&lsquo;s breathing in the time right after the arytenoidectomy surgery?
            </span>
          }
          index={18}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="ProcedurePAECoughGagRetch">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAECoughGagRetchChange">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEBadBreath">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEBadBreathChange">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAERegurgitate">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAERegurgitateChange">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEMucus">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAEMucusChange">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-panel-container" id="ProcedurePAELongTermPanel">
      <div className="browse-content-block" id="ProcedurePAELongTermHeading">
        <p className="browse-content-text">These questions are about the long-term effects of Bella&lsquo;s arytenoidectomy surgery.</p>
      </div>

      <div className="browse-question-container" id="ProcedurePAEBreathingLongTerm">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              In the long-term, how did Bella&lsquo;s breathing change over time?
            </span>
          }
          index={27}
          activeIndex={activeIndex}
      ...
      <div className="browse-question-container" id="ProcedurePAESymptomsReturnedTime">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
      ...
      <div className="browse-question-container" id="ProcedurePAESatisfaction">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
              How would you rate your satisfaction with Bella&lsquo;s arytenoidectomy procedure?
            </span>
          }
          index={29}
          activeIndex={activeIndex}
