  ...
  return (
    <>
      ...
      <div className="browse-content-block" id="ProcedureVCCHeading">
        <h3 className="browse-content-subheading">Questions About Bella&lsquo;s Ventrilucordectomy Surgery</h3>
      </div>

      <div className="browse-panel-container" id="ProcedureVCCAgePanel">
        <h3 className="browse-showanswer-title">At about what age did Bella have the ventrilucordectomy procedure for LP/ GOLPP?</h3>
      ...
      <div className="browse-content-block" id="ProcedureVCCSurgeryOpHeading">
      ...
      <div className="browse-question-container" id="ProcedureVCCExtendedStayTiebackRepeat">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
