  ...
  return (
    <>
      ...
      <div className="browse-page-nav" aria-label="Browse page navigation">
        <Link className="browse-page-nav__prev" href="/browse-mode/Browse_03_InfoSources" aria-label="Previous page">
        ...
        <div className="browse-page-marker" id="INTUBATION_HISTORY-page"></div>
        <Link className="browse-page-nav__next" href="/browse-mode/Browse_05_BreathingCrisis" aria-label="Next page">
