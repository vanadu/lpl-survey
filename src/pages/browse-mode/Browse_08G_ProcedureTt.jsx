  ...
  return (
    <>
      ...
      <div className="browse-content-block" id="ProcedureTTHeading">
        <h3 className="browse-content-subheading">Questions About Bella&lsquo;s Tracheostomy Surgery</h3>
      </div>

      <div className="browse-panel-container" id="ProcedureTTAgePanel">
        <h3 className="browse-showanswer-title">At about what age did Bella have the tracheostomy procedure for LP/ GOLPP?</h3>
      ...
      <div className="browse-content-block" id="ProcedureTTSurgeryOpHeading">
      ...
      <div className="browse-question-container" id="ProcedureTTExtendedStayTiebackRepeat">
        <ShowAnswerContent
          header={
            <span className="showanswer__title">
