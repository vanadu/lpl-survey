        ...
        <section className="content-body privacy-info home-head">
          <article className="card privacy-info-card">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Overview</h2>
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">What We Collect</h2>
              <p className="privacy-info-text">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">How Your Data Is Used</h2>
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Legal Basis (EU/EEA)</h2>
              <p className="privacy-info-text">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Data Storage and Security</h2>
              <ul className="privacy-info-list">
                <li className="privacy-info-list-item">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Data Retention</h2>
              <p className="privacy-info-text">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Data Sharing</h2>
              <p className="privacy-info-text">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">International Transfers</h2>
              <p className="privacy-info-text">
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Your Rights (EU/EEA)</h2>
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Data Controller</h2>
            ...
            <article className="card privacy-info-section">
              <h2 className="privacy-info-heading">Contact</h2>
              <p className="privacy-info-text">
