...
const Browse_15_Neuropathy = () => {
  ...
  return (
    ...
    <main className='page browse'>
      ...
      <p className="browse-content-text">This section asks questions about whether &#123;CmpnName&#125; showed symptoms of polyneuropathy and how these symptoms progressed over time.</p>

      <p className="browse-content-text">&lt;b&gt;NOTE:&lt;/b&gt; Polyneuropathy refers to the weakening of motor function due to neurological degeneration, particularly in the hind end. Symptoms can include hind-end weakness and incontinence. Younger dogs with idiopathic LP often don&lsquo;t suffer from LP-related polyneuropathy.</p>

      <div className="browse-panel-container"></div>

      <div className="browse-question-container">
        <ShowAnswerContent
          title="Over the course of {CmpnName}'s LP/GOLPP journey, did {CmpnName} experience persistent hind-end weakness?"
          index={1}
      ...
      <div className="browse-question-container">
        <ShowAnswerContent
          title="Which LP/GOLPP symptom appeared first in {CmpnName}?"
          index={2}
          activeIndex={activeIndex}
          setActiveIndex={setActiveIndex}
        >
      ...
      <div className="browse-question-container">
        <ShowAnswerContent
          title="Over the course of {CmpnName}'s LP/GOLPP, did any of these issues also appear?"
          index={6}
          activeIndex={activeIndex}
          setActiveIndex={setActiveIndex}
        >
          ...
          <ul>
            ...
            <li className="browse-showanswer-checkbox">
              <span className="browse-showanswer-icon browse-showanswer-icon--checkbox" aria-hidden="true"></span>
              <span>No, &#123;CmpnName&#125; never had any of these issues</span>
            </li>
          </ul>
          </div>
        </ShowAnswerContent>
