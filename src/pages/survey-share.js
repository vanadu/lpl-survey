      ...
      <main className="page home">
        ...
        <article className="card">
          <div className="share-grid">
            <a href="#" className="share-btn">{Icon.facebook}<span>Facebook</span></a>

            <a href="#" className="share-btn">{Icon.email}<span>Email</span></a>

            <a href="#" className="share-btn">{Icon.linkedin}<span>LinkedIn</span></a>

            <a href="#" className="share-btn">{Icon.reddit}<span>Reddit</span></a>

            <a href="#" className="share-btn">{Icon.slack}<span>Slack</span></a>

            <a href="#" className="share-btn">{Icon.discord}<span>Discord</span></a>
